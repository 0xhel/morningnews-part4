...
function Header() {
	...
	if (user.token) {
		...
		if (isModalVisible) {
			userSection = <FontAwesomeIcon onClick={showModal} className={styles.userSection} icon={faXmark} />;
		} else {
			userSection = <FontAwesomeIcon onClick={showModal} className={styles.userSection} icon={faUser} />;
		}
	}
